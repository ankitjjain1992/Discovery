...
public class Scripts1 extends SeleniumDrivers
{
	 ...
	 * Mark some recommended content as favorite and verify same program is showing in my video page
	*/
	...
	public void script1() throws Exception
	{
		...
		ArrayList<String> programNames = home.makeprogramFav(Integer.parseInt(jObject.get("numberofProgram").toString()));
